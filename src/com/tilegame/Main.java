...
public class Main extends GameCore {//Entry point
    ...
    public void init() {
        ...
        drawer = new TileMapDrawer();// load resources
        drawer.setBackground(mapLoader.loadImage("background.jpg"));
        map = mapLoader.loadNextMap();// load first map
    }
    /**
    ...
    public void acquirePowerUp(PowerUp powerUp) {
        ...
        if (powerUp instanceof PowerUp.Star) {
            collectedStars++;// do something here, like give the player points
            if(collectedStars==100) {
                numLives++;collectedStars=0;
            }
        } else if (powerUp instanceof PowerUp.Music) {// change the music
        } else if (powerUp instanceof PowerUp.Goal) {
            map = mapLoader.loadNextMap();// advance to next map
        }
    }
}
